                            ...
                            <table class="table table-bordered table-striped table-condensed cf">
                               ...
                               ?>
                                <tr>
                                    ...
                                    <td data-title="Category Image" style="text-align:center;"><img src="<?php echo BASE_PATH; ?>/uploads/<?php if($value['category_image']) echo $value['category_image']; else echo 'default_category.jpg'; ?>" style="width:100px;"></td>
